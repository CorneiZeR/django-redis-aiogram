...
| `an events_recorded receiver raised` | ERROR | one of your metrics receivers raised; the batch still reached the others and the database. `tg_receiver` names it |
